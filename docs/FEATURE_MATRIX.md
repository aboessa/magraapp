...
> Generated by `node tools/dashboard-audit/feature-matrix.mjs`. Do not edit by hand; edit `docs/FEATURE_MATRIX_VERDICTS.json` and regenerate.
...
| `/creative-studio/draw-like-me` | CreativeDrawLikeMeAdminPage.tsx | UI_ONLY | 0 | 0/0 | — | — | 0 |
...
| `/production/factory/:runId` | ContentFactoryRunPage.tsx | UNVERIFIED | 7 | 7/7 | approve, publish, review | ✅ | 1 |
| `/calendar` | ContentCalendarPage.tsx | COMPLETE | 2 | 1/1 | — | — | 1 |
...
| `/ops/incidents` | OpsIncidentWorkspacePage.tsx | UNVERIFIED | 2 | 2/2 | edit_metadata | ✅ | 0 |
| `/ops/incidents/:id` | OpsIncidentWorkspacePage.tsx | UNVERIFIED | 2 | 2/2 | edit_metadata | ✅ | 0 |
| `/ops/alerts` | OpsPage.tsx | UI_ONLY | 0 | 0/0 | — | — | 0 |
| `/ops/queues/:name` | OpsServiceWorkspacePage.tsx | UNVERIFIED | 1 | 1/1 | — | — | 0 |
| `/ops/telemetry` | OpsPage.tsx | UI_ONLY | 0 | 0/0 | — | — | 0 |
| `/campaigns` | CampaignsPage.tsx | PARTIAL | 2 | 2/2 | edit_metadata | ✅ | 1 |
...
- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and CampaignsPage.tsx calls 2 endpoint(s): campaigns, createCampaign. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted.
- Gaps:
...
- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and RevenuePage.tsx calls 2 endpoint(s): revenueDrilldown, revenueOverview. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted.
- Gaps:
  - Feature completeness was not audited in this pass: presence of endpoints is not proof of a finished workflow.
...
- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and TranslationCenterPage.tsx calls 4 endpoint(s): createGlossaryTerm, glossary, translationMemory, translationQueue. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted.
- Gaps:
  - Feature completeness was not audited in this pass: presence of endpoints is not proof of a finished workflow.
...
- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and QuizBuilderPage.tsx calls 5 endpoint(s): createQuestion, exportQuestions, importQuestions, learningObjectives, questions. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted.
- Gaps:
  - Feature completeness was not audited in this pass: presence of endpoints is not proof of a finished workflow.
...
- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and RecommendationsPage.tsx calls 4 endpoint(s): createRecommendation, deleteRecommendation, recommendations, updateRecommendation. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted. The eligibility preview still runs on four hard-coded candidates, not on catalogue rows.
- Gaps:
  - Feature completeness was not audited in this pass: presence of endpoints is not proof of a finished workflow.
...
- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and SchoolAccountsPage.tsx calls 6 endpoint(s): assignSchoolTeacher, createClassroom, createSchool, enrollStudent, school, schools. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted.
- Gaps:
  - Feature completeness was not audited in this pass: presence of endpoints is not proof of a finished workflow.
  - Whole B2B block absent

### `/finance-advanced` — PARTIAL

- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and AdvancedFinancePage.tsx calls 2 endpoint(s): contentCosts, createContentCost. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted.
- Gaps:
  - Feature completeness was not audited in this pass: presence of endpoints is not proof of a finished workflow.
...
- Verified by: code read 2026-08-29
- Evidence: Route registered in AdminRoutes.tsx and OpsSlaPage.tsx calls 4 endpoint(s): createSlaPolicy, slaCommandCenter, slaPolicies, supportFamily. A server route answers each. The previous verdict cited NotImplementedPage as evidence; that component was unused everywhere and has been deleted. The list has no toolbar or pagination; its imports for them were unused and were removed.
- Gaps:
  - Feature completeness was not audited in this pass: presence of endpoints is not proof of a finished workflow.
...
|---|---|---|---|---|
| account.ts | GET | `/api/v1/account/profile` | — | — |
| account.ts | PATCH | `/api/v1/account/profile` | — | — |
| account.ts | POST | `/api/v1/account/change-password` | — | — |
| account.ts | GET | `/api/v1/account/export` | — | — |
| account.ts | GET | `/api/v1/account/deletions/:requestId` | — | — |
| account.ts | POST | `/api/v1/account/deletions/status` | — | — |
| account.ts | DELETE | `/api/v1/account/children/:childId` | — | — |
| account.ts | DELETE | `/api/v1/account/delete` | — | — |
...
| adminBilling.ts | POST | `/api/v1/admin/billing/grant` | manage_billing | ✅ |
| adminCampaigns.ts | PATCH | `/api/v1/admin/campaigns/:id` | edit_metadata | ✅ |
| adminCampaigns.ts | POST | `/api/v1/admin/campaigns/:id/schedule` | publish | ✅ |
| adminCampaigns.ts | POST | `/api/v1/admin/campaigns/:id/cancel` | edit_metadata | ✅ |
...
| adminCommerce.ts | GET | `/api/v1/admin/pricing/matrix` | — | — |
| adminCommerce.ts | GET | `/api/v1/admin/store-products` | — | — |
| adminCommerce.ts | POST | `/api/v1/admin/store-products` | edit_metadata | ✅ |
| adminCommerce.ts | PATCH | `/api/v1/admin/store-products/:id` | edit_metadata | ✅ |
| adminCommerce.ts | POST | `/api/v1/admin/store-products/:id/status` | publish | ✅ |
| adminCommerce.ts | POST | `/api/v1/admin/pricing` | edit_metadata | ✅ |
| adminCommerce.ts | PATCH | `/api/v1/admin/pricing/:id` | edit_metadata | ✅ |
| adminCommerce.ts | POST | `/api/v1/admin/pricing/:id/status` | publish | ✅ |
| adminCommerce.ts | GET | `/api/v1/admin/payment-methods` | — | — |
| adminCommerce.ts | POST | `/api/v1/admin/payment-methods` | edit_metadata | ✅ |
| adminCommerce.ts | PATCH | `/api/v1/admin/payment-methods/:id` | edit_metadata | ✅ |
| adminCommerce.ts | POST | `/api/v1/admin/payment-methods/:id/status` | publish | ✅ |
| adminCommerce.ts | GET | `/api/v1/admin/promotions` | — | — |
...
| adminCreativeStudio.ts | GET | `/api/v1/admin/creative-studio/drawings` | — | — |
| adminCreativeStudio.ts | GET | `/api/v1/admin/creative-studio/drawings/:id` | — | — |
| adminCreativeStudio.ts | POST | `/api/v1/admin/creative-studio/drawings` | create | ✅ |
| adminCreativeStudio.ts | PATCH | `/api/v1/admin/creative-studio/drawings/:id` | update | ✅ |
| adminCreativeStudio.ts | DELETE | `/api/v1/admin/creative-studio/drawings/:id` | delete | ✅ |
| adminCreativeStudio.ts | POST | `/api/v1/admin/creative-studio/drawings/:id/upload` | create | ✅ |
| adminCreativeStudio.ts | POST | `/api/v1/admin/creative-studio/drawings/reorder` | update | — |
| adminCreativeStudio.ts | POST | `/api/v1/admin/creative-studio/generate` | create | ✅ |
| adminCreativeStudio.ts | GET | `/api/v1/admin/creative-studio/stats` | — | — |
| adminEpisodeStreaming.ts | GET | `/api/v1/admin/episodes/:id/streaming` | — | — |
| adminEpisodeStreaming.ts | PUT | `/api/v1/admin/episodes/:id/streaming` | edit_metadata | — |
| adminEpisodeStreaming.ts | POST | `/api/v1/admin/episodes/:id/audio-tracks` | edit_metadata | — |
| adminEpisodeStreaming.ts | DELETE | `/api/v1/admin/episodes/:id/audio-tracks/:trackId` | edit_metadata | — |
| adminEpisodeStreaming.ts | POST | `/api/v1/admin/episodes/:id/subtitle-tracks` | edit_metadata | — |
| adminEpisodeStreaming.ts | DELETE | `/api/v1/admin/episodes/:id/subtitle-tracks/:trackId` | edit_metadata | — |
| adminEpisodeStreaming.ts | POST | `/api/v1/admin/episodes/:id/renditions` | edit_metadata | — |
| adminEpisodeStreaming.ts | DELETE | `/api/v1/admin/episodes/:id/renditions/:rendId` | edit_metadata | — |
| adminExecutive.ts | GET | `/api/v1/admin/dashboard/executive` | — | — |
...
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/services` | — | — |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/overview` | — | — |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/alerts` | — | — |
| adminOpsReliability.ts | POST | `/api/v1/admin/ops/alerts/:id/acknowledge` | edit_metadata | ✅ |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/incidents` | — | — |
| adminOpsReliability.ts | POST | `/api/v1/admin/ops/incidents` | edit_metadata | ✅ |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/queues` | — | — |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/queues/:name` | — | — |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/telemetry` | — | — |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/timeline` | — | — |
| adminOpsReliability.ts | GET | `/api/v1/admin/sla/policies/:id` | — | — |
| adminOpsReliability.ts | GET | `/api/v1/admin/ops/failed-grouped` | — | — |
| adminPartnerships.ts | GET | `/api/v1/admin/partnerships/:id` | — | — |
| adminPlanets.ts | GET | `/api/v1/admin/planets/:id` | — | — |
| adminPublish.ts | POST | `/api/v1/admin/stories/:id/publish` | publish | — |
| adminPublish.ts | POST | `/api/v1/admin/books/:id/publish` | publish | — |
| adminPublish.ts | POST | `/api/v1/admin/games/:id/publish` | publish | — |
| adminPublish.ts | POST | `/api/v1/admin/projects/:id/publish` | publish | — |
| adminQuestions.ts | DELETE | `/api/v1/admin/questions/:id` | archive | ✅ |
| adminSchools.ts | PATCH | `/api/v1/admin/schools/:id` | manage_team | ✅ |
| adminSchools.ts | GET | `/api/v1/admin/schools/:id/classrooms` | — | — |
| adminSchools.ts | GET | `/api/v1/admin/schools/:id/enrollments` | — | — |
...
| adminTeams.ts | PATCH | `/api/v1/admin/roles/:id` | manage_permissions | — |
...
| adminTranslation.ts | PATCH | `/api/v1/admin/glossary/:id` | edit_metadata | ✅ |
| adminTranslation.ts | DELETE | `/api/v1/admin/glossary/:id` | archive | ✅ |
...
| analyticsIngest.ts | POST | `/api/v1/analytics/events` | — | — |
| analyticsIngest.ts | GET | `/api/v1/analytics/events` | — | — |
| appConfig.ts | GET | `/api/v1/app-config` | — | — |
| auth.ts | POST | `/api/v1/auth/register` | — | — |
| auth.ts | POST | `/api/v1/auth/resend-verification` | — | — |
| auth.ts | POST | `/api/v1/auth/verify-email` | — | — |
| auth.ts | POST | `/api/v1/auth/forgot-password` | — | — |
| auth.ts | POST | `/api/v1/auth/reset-password` | — | — |
...
| billing.ts | GET | `/api/v1/billing/catalog` | — | — |
...
| childSettings.ts | GET | `/api/v1/child-settings/:childId` | — | — |
| childSettings.ts | PUT | `/api/v1/child-settings/:childId` | — | — |
...
| creative.ts | GET | `/api/v1/creative/reference-activities` | — | — |
| creative.ts | GET | `/api/v1/creative/reference-activities/:id` | — | — |
| creative.ts | GET | `/api/v1/creative/coloring` | — | — |
| downloads.ts | POST | `/api/v1/downloads/sessions` | — | — |
| downloads.ts | POST | `/api/v1/downloads/sessions/:licenceId/refresh` | — | — |
| downloads.ts | POST | `/api/v1/downloads/sessions/:licenceId/complete` | — | — |
| downloads.ts | POST | `/api/v1/downloads/licences/:licenceId/renew` | — | — |
| downloads.ts | POST | `/api/v1/downloads/licences/:licenceId/revoke` | — | — |
| downloads.ts | GET | `/api/v1/downloads` | — | — |
...
| episodes.ts | GET | `/api/v1/episodes/:id/hls/master.m3u8` | — | — |
| family.ts | GET | `/api/v1/family/state` | — | — |
| family.ts | GET | `/api/v1/family/children` | — | — |
| family.ts | POST | `/api/v1/family/children` | — | — |
| family.ts | PATCH | `/api/v1/family/children/:childId` | — | — |
| family.ts | POST | `/api/v1/family/children/:childId/track-transition` | — | — |
...
| family.ts | POST | `/api/v1/family/parent-proof/authorize` | — | — |
| games.ts | GET | `/api/v1/games` | — | — |
| games.ts | GET | `/api/v1/games/:id` | — | — |
| homeResolved.ts | GET | `/api/v1/home/resolved` | — | — |
| media.ts | GET | `/api/v1/media/assets/:assetId` | — | — |
| notifications.ts | GET | `/api/v1/notifications` | — | — |
| notifications.ts | POST | `/api/v1/notifications/:id/read` | — | — |
| notifications.ts | POST | `/api/v1/notifications/test` | — | — |
| partnerships.ts | POST | `/api/v1/partnerships` | — | — |
| partnerships.ts | GET | `/api/v1/partnerships/status` | — | — |
| planets.ts | GET | `/api/v1/planets/:id` | — | — |
| publicCreativeStudio.ts | GET | `/api/v1/creative-studio/home` | — | — |
| publicCreativeStudio.ts | GET | `/api/v1/creative-studio/drawings` | — | — |
| publicCreativeStudio.ts | GET | `/api/v1/creative-studio/drawings/:id` | — | — |
| publicRender.ts | GET | `/` | — | — |
...
| publicSite.ts | GET | `/api/v1/site/resolve` | — | — |
| publicSite.ts | GET | `/api/v1/site/page` | — | — |
| publicSite.ts | GET | `/api/v1/site/blog` | — | — |
| publicSite.ts | GET | `/api/v1/site/blog/post` | — | — |
| publicSite.ts | GET | `/api/v1/site/sitemap.xml` | — | — |
| publicSite.ts | GET | `/api/v1/site/sitemap-pages.xml` | — | — |
| publicSite.ts | GET | `/api/v1/site/sitemap-blog.xml` | — | — |
| publicSite.ts | GET | `/api/v1/site/sitemap-catalogue.xml` | — | — |
| publicSite.ts | GET | `/api/v1/site/sitemap-index.xml` | — | — |
...
| stories.ts | GET | `/api/v1/stories` | — | — |
| stories.ts | GET | `/api/v1/stories/:id` | — | — |
