...
abstract final class LocalCatalog {
  static const planets = <Planet>[
    Planet(
      ...
      colorHex: '#2580FF',
      imageAsset: 'assets/images/planets/planet-abjad.png',
    ),
    Planet(
      id: 'arqam',
      name: 'كوكب الأرقام',
      ...
      colorHex: '#FFB52E',
      imageAsset: 'assets/images/planets/planet-numbers.png',
    ),
    Planet(
      id: 'oloom',
      name: 'كوكب العلوم',
      ...
      colorHex: '#32C979',
      imageAsset: 'assets/images/planets/planet-science.png',
    ),
    Planet(
      id: 'qiyam',
      name: 'كوكب القيم',
      ...
      colorHex: '#FF6FAE',
      imageAsset: 'assets/images/planets/planet-values-islamic.png',
    ),
    Planet(
      id: 'qisas',
      name: 'كوكب القصص',
      ...
      colorHex: '#9D68FF',
      imageAsset: 'assets/images/planets/planet-stories.png',
    ),
    Planet(
      id: 'ibdaa',
      name: 'كوكب الإبداع',
      ...
      colorHex: '#6A3DF2',
      imageAsset: 'assets/images/planets/planet-creativity.png',
    ),
    Planet(
      id: 'maharat',
      name: 'كوكب المهارات',
      ...
      colorHex: '#00BFA6',
      imageAsset: 'assets/images/planets/planet-maharat.png',
    ),
    Planet(
      id: 'tarikh',
      name: 'كوكب التاريخ',
      ...
      colorHex: '#D9903D',
      imageAsset: 'assets/images/planets/planet-tarikh.png',
    ),
    Planet(
      id: 'iman',
      name: 'كوكب الإيمان',
      ...
      colorHex: '#2FBF8F',
      imageAsset: 'assets/images/planets/planet-iman.png',
    ),
  ];
