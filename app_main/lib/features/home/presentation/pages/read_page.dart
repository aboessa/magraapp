              ...
              slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: ContentRail<StoryItem>(
                        title: 'قصص مصورة',
                        items: catalog.stories.take(6).toList(),
                        height: 282,
                        horizontalPadding: padding,
                        itemBuilder: (c, item, i) => BookCard(
                          item: BookItem(
                            ...
                            ageMax: item.ageMax,
                            posterAsset:
                                'assets/images/explore/explore-read.webp',
                            coverUrl: item.coverUrl,
                          ),
                          isTelevision: false,
                          onPressed: () => context.push(
                            '/reader/${item.id}?contentType=story',
                          ),
                        ),
                      ),
                    ),
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Text(
                      'القصص والكتب منفصلان خلف الكواليس — الواجهة فقط تجمعهما للاستكشاف',
                      style: TextStyle(
