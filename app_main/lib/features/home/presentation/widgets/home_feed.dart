  ...
  Widget build(BuildContext context) {
    ...
    final items = <_RailDest>[
      _RailDest(
        ...
        artworkAsset: catalog.series.firstOrNull?.bannerAsset ?? catalog.series.firstOrNull?.posterAsset ?? 'assets/images/series/banners/hekaya-wa-hikma-banner.webp',
        artworkUrl: catalog.series.firstOrNull?.coverUrl,
      ...
      _RailDest(
        ...
        artworkAsset: catalog.experiences.where((e) => e.isServerBacked).firstOrNull?.imageAsset ?? 'assets/images/games/game-thumb.webp',
        artworkUrl: null,
      ...
      _RailDest(
        ...
        artworkAsset: catalog.stories.firstOrNull?.coverUrl != null ? 'assets/brand/majarra-logo.png' : (catalog.books.firstOrNull?.posterAsset ?? 'assets/brand/majarra-logo.png'),
        artworkUrl: catalog.stories.firstOrNull?.coverUrl ?? catalog.books.firstOrNull?.coverUrl,
      ...
      if (hasAudio)
        _RailDest(
          ...
          artworkAsset: catalog.books.where((b) => b.type == 'audio_story').firstOrNull?.posterAsset ?? 'assets/brand/majarra-logo.png',
          artworkUrl: catalog.books.where((b) => b.type == 'audio_story').firstOrNull?.coverUrl,
      ...
      _RailDest(
        ...
        artworkAsset: 'assets/images/games/game-thumb.webp',
        artworkUrl: null,
      ...
      _RailDest(
        ...
        artworkAsset: catalog.planets.firstOrNull?.imageAsset ?? 'assets/images/planets/planet-science.webp',
        artworkUrl: null,
