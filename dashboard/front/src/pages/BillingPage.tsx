...
const copy = {
  ar: {
    ...
    lede: 'Google Play يتحقق من الشراء، وFamilyState هو مصدر الخطة والاستحقاق الفعليين.',
    plansTitle: 'آخر الخطط المدفوعة المسقطة حسب الخطة',
    ...
    event: 'الحدث',
    when: 'الوقت',
    noPlans: 'لا خطط مدفوعة مسقطة',
    noPlansHint: 'هذه آخر بيانات الإسقاط بعد شراء Google Play متحقَّق، وقد تتأخر عن حالة FamilyState الحية.',
    noPurchases: 'لا عمليات شراء',
    noPurchasesHint: 'كل شراء مُتحقَّق يُسجَّل في billing_audit.',
    noEntitlements: 'لا أحداث استحقاق',
    noEntitlementsHint: 'تظهر الأحداث بعد تحديث Google Play متحقَّق، سواءً من التحقق الأولي أو إشعار RTDN.',
    loadError: 'تعذر تحميل بيانات الفوترة',
    none: '—',
    refresh: 'تحديث',
    tabOverview: 'نظرة عامة',
    tabPurchases: 'سجل الشراء',
    tabEntitlements: 'آخر الخطط المدفوعة المسقطة',
    ...
    activeTitle: 'آخر الخطط المدفوعة المسقطة',
    activeHint: 'من family_projection بعد الأحداث؛ الخطط المجانية مستثناة. ليست هذه قراءة لحظية للاستحقاق، فـFamilyState هو المصدر الحي.',
    noDates: 'بلا تواريخ',
  ...
  en: {
    ...
    lede: 'Google Play verifies purchases; FamilyState is the authority for the effective plan and entitlement.',
    plansTitle: 'Last projected paid plans by plan',
    ...
    event: 'Event',
    when: 'When',
    noPlans: 'No projected paid plans',
    noPlansHint: 'This is the latest projection after a verified Google Play purchase and can lag the live FamilyState status.',
    noPurchases: 'No purchases',
    noPurchasesHint: 'Every verified purchase is recorded in billing_audit.',
    noEntitlements: 'No entitlement events',
    noEntitlementsHint: 'Events appear after a verified Google Play update, from initial verification or an RTDN notification.',
    loadError: 'Unable to load billing data',
    none: '—',
    refresh: 'Refresh',
    tabOverview: 'Overview',
    tabPurchases: 'Purchase ledger',
    tabEntitlements: 'Last projected paid plans',
    ...
    activeTitle: 'Last projected paid plans',
    activeHint: 'From family_projection after events, with free plans excluded. This is not a live entitlement decision; FamilyState is the live authority.',
    noDates: 'No dates',
