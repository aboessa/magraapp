...
export function MediaLibraryPage() {
  ...
  // الأصول اليتيمة (`CNT-104`): لا تُحمَّل مع الصفحة — الاستعلام يبني شرط
  // `NOT EXISTS` لكل مسار ربط في المخطَّط، فهو أثقل من قراءة قائمة. ويُطلب بزرّ.
