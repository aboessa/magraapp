/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c90d239cfaa9e439f7155c0358462619)
// Runtime types generated with workerd@1.20260730.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	...
	API_VERSION: "v1";
	FAMILY_STATE: DurableObjectNamespace<import("./src/index").FamilyState>;
	IDENTITY_STATE: DurableObjectNamespace<import("./src/index").IdentityState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FamilyState" | "IdentityState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "API_VERSION">> {}
}
